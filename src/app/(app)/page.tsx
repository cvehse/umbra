  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link href="/scan" className="btn-primary"><Radar size={16} /> Scan a domain</Link>
      </div>
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link href="/radar" className="flex items-center gap-1 text-xs font-medium text-brand-soft hover:text-brand">
